    ...
    def _compute_visible(self):
        ...
        for menu in self:
            ...
            if self.env.user == self.env.ref('base.public_user'):
                ...
                # print("\n\nself.env.user.has_group('pragmatic_odoo_delivery_boy.group_pragtech_driver'): ",self.env.user.has_group('pragmatic_odoo_delivery_boy.group_pragtech_driver'))
                # print("\nself.env.user.has_group('pragmatic_delivery_control_app.group_delivery_control_app_manager'): ",self.env.user.has_group(
                #         'pragmatic_delivery_control_app.group_delivery_control_app_manager'))
