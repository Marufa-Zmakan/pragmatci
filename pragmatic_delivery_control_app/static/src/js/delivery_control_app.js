...
//}
    ...
    function initMap() {
      ...
      function calculateAndDisplayRoute_H(directionsService, directionsRenderer) {
        let route_values = document.getElementById('route_values').value;
        console.log("route:::+++::::::::::",route_values);
        if(!route_values)
            return;
        let route = JSON.parse(route_values);
...
//             console.log("new route2: ",new_route)
            ...
            new_route[route.length-1] = [route.length-1, route[route.length-1][0], route[route.length-1][1], route[route.length-1][2]]
...
//                    else if (i== result.length-1)
//                        summaryPanel.innerHTML +=
//                            "<b>Sequence "+String.fromCharCode(65+i)+": "+ result[i][3] +"</b><br>";
                    else
                        summaryPanel.innerHTML +=
                            "<b>Sequence "+String.fromCharCode(65+i)+": "+ result[i][3] +"</b><br>";
                }
...
//            }
        ...
        {
            console.log("In js customer delivery route")
